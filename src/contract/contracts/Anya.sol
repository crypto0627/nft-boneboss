...
contract Anya is ERC721, ReentrancyGuard, Ownable {
  ...
  uint256 public constant PRICE = 150000000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 150 ETH per item"
    );
